...
from src.decoder.conv_onet.models import quantize_3plane
from src.decoder.conv_onet.models import decoder
...
quantizer_dict = {
    'quantize_3plane': quantize_3plane.Quantize_multi_improve_revise, 
}
